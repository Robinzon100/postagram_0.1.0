export const lang = {
    eng: {
        ...
        index: {
            hero_title: 'Our experience is <br/> your advantage',
            hero_description: 'Our team is ready to respond <br/> to any questions you may have.',
            hero_button: 'search',
    ...
    rus: {
        ...
        index: {
            hero_title: 'Наш опыт -ваше <br/> преимущество',
